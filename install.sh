...
sudo apt-get install -y apache2 libapache2-mod-php php-cli php-common php-cgi php git-core build-essential python-dev python3-pip pastebinit php8.0-mbstring python3-configobj || die
